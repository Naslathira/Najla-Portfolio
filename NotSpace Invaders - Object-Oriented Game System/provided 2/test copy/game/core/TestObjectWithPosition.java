...
/**
 * Unit tests for the toString() implementation in ObjectWithPosition subclasses.
 *
 * These tests ensure that each subclass (Asteroid, Bullet, Ship)
 * returns the correct string representation based on its position.
 */
public class TestObjectWithPosition {
